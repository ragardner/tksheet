...
ICON_DOWN = (
    """iVBORw0KGgoAAAANSUhEUgAAABQAAAAUCAYAAACNiR0NAAAAAXNSR0IArs4c6QAAAe5JREFUOE99Vdt1"""
    """wyAMlQ4exN6km+R4EIsDDJJ2krST2IPEpb0IDNhp/RESgx73IcLERByJIhNRJH3++N6+xiFOgRqW9pjT"""
    """eslRimADh4P3j0i0icjcn87hOXEqUhL+0xgFH1YktnaZYtRu8IHvx5NfdgnPmymCibzzK1ZZZKodYise"""
    """LGXMTYfgMpetfGq94N2KVUSm1FRPZgsyg25aZ0Bp8CDWeXTIJMsylVxHzoIfUQlQAd0mTYplrn4PueBX"""
    """YEOHCKhANe3ZFB11Z+egYwcOM+ROxCRMKaFr0b2rpJ5SzyjksOKHiJ3UtIXIYqwiVQKszq7mbgDkzCG4"""
    """FYID8gvXgt7O4FcOmCk2JvMQhZhElun1GDWwO7UA8ZQM1YL3auxFbaM8aaRyXqWqondIGyWLsXOH9Zgm"""
    """6VnsimHYURRV+xsDkLG1WJlOo9HfA8VqxQqtn7z3dyL6EpF35ZDIikxi7Zsx5ibWzjrMpbgCB2XJS/oo"""
    """BGvtOBhzj0xj/I4fzHzD+31/zsYMDybaFijehmWp28Gp9slJjTEIhidHirQx0YhrbN/32Tn32fOpErWC"""
    """XabeioxmGB6kCYFp25+arLsRDtET6OamPg0htsTKaMwAPsejs8bJaebL8ByWygNzvTF19qzY0Tm39RfD"""
    """67+KH8u+BjTC9Jx1AAAAAElFTkSuQmCC"""
)


ICON_UP = (
    """iVBORw0KGgoAAAANSUhEUgAAABQAAAAUCAYAAACNiR0NAAAAAXNSR0IArs4c6QAAAeJJREFUOE91VMFh"""
    """wyAMlEL2qL1JM0nbQRABD9KO0k2cQeLSSggQJPUnJlgn6XQnRADIwE9/k6P5a7yZItqxvKAAYa6oBZjP"""
    """8oZARItzbkeA2/04LjHG25B/CucYgMw/WSvVWhEgUKhggpEVNAloT8zxts/WYe2ar30Iy9m53fauaW/H"""
    """cVwYVPqwfJR+J8I0c4qJ21zu9+Pizu5Tv4oI8JkRvsnTxUYyFPeItVn8a1EyZgAKtLjT6f3nJ38xZyml"""
    """nQOI/BpCeHVn90Y+fJQIHQbH56HCedCd15S2nYMD0dohen0FsmtlkEinoL+lLe1MPAW/2gHYb1unzwBm"""
    """WW4p7TxI8mEt34veSk2WKz1WSTyOTAOZQw4mogKoo8SsYjOTLlc2y3TJtaQURT4CaJ2hhhCQPhQrUCVg"""
    """sBMIIOf0vgC2ygxfNaTp8ImTWzHcMgOSL1O2HFsg5tkI+5/xIECKRTaNQ0W0dq1OnACfeRqBXSM6DLSy"""
    """eMdn9B53Mq6vyZscvEUrG0Uctkytq8hJF8fQQBs+Z4tivT7leSiICFl9VyfeVpe4O/dVxinFy38rk60n"""
    """sp6WaqcARYFSYjaamtdSjNcr4umFiD4e9lUvRVeyZVgEriujUwVEYYkp3ooBzIX9VKv+Bdx//BzVt0Js"""
    """AAAAAElFTkSuQmCC"""
)


ICON_LEFT = (
    """iVBORw0KGgoAAAANSUhEUgAAABQAAAAUCAYAAACNiR0NAAAAAXNSR0IArs4c6QAAAZZJREFUOE99Vdtx"""
    """AjEMlMekjysllEIhSBwUQlIJdHIUEqKMZNmWH5f74GZ88mp39SCAPEF/AdjeEPSIge1tMfY9fcsXyyWN"""
    """zVB7NybJclL3zhmCAywk5ZCNQaXSoth5YRMCMFfOJbhXPkoTK8SIUa5wk29hRqICp69NjFfQUwkptj49"""
    """+pCtRxuqmQDzMRIt8RA3/uWViC6Kt+9DuthVvkgmAYtxk5if989xXa/PWYlnLnohWmgiXA7xsInd7wJm"""
    """ToyqXEnGCmj49XbbgHkBgNfO/bnRrv+A4YlIp0BIS/yI98DwacOioG1tczF8I9UGsmwvRDzqjClojA8J"""
    """fzN/rxe6WJ9qyYars+pLdSRvDreiPCzbikhfbri7easaBIV1tPKZ1FnoCNOzts1dvETEU9+ghZj3rlkq"""
    """yrCAqzyk83Jdr69/G342ekosA7oRSn7tDGTZGrNZTmd58SVok5663yrbSWrGNzlVCfj1NWzS1ovZFi4c"""
    """/AyWWc57txXrWsYlyGLGrRIgmJdNhxQZ5tle26krIrn+C8AfBivCH/gZ27EAAAAASUVORK5CYII="""
)


ICON_RIGHT = (
    """iVBORw0KGgoAAAANSUhEUgAAABQAAAAUCAYAAACNiR0NAAAAAXNSR0IArs4c6QAAAadJREFUOE+NVIGx"""
    """wjAIhdZB6iY6iTrITyQO4ig6Sgaxl/9JICFtvPs9TyshwHs8QPjXgwCQhp58wk8+xfyRN3MhX995pk3M"""
    """URIExByzZG9Bts7tvz3Rd82tpXVQdldNBESA1CFnjK1ydmWfjh2bdcda59w8ERKkTGD+LkRmuEnegblI"""
    """kNQomfvq9uxzdRa+tIfzad9MZ0xW5p0CPQHgtK7rmYii9lZiGnBC1IivDE2QPEK4JgAOGjloIIp8VgOO"""
    """RSAas42p9CCEQFcEeCbAuK6fMwWKuSkUQi7fKKggqF0tEYfyRliEo+idO6L3fpmm6YqIl6YfI4deGZ2L"""
    """4F+Ev+h+3LHpuqaXajrNbaKKr3f+dDjMr1R4vAWid54UVlEnH5USm3U4k+k+InjnTvM8v0pTPjei8G6T"""
    """Yltq9fhtSv7s9zvdJ8QLV0ZEb87MKSvknvDx/Fird26hR4jbJdQmxU52leVmso3Od7tMkVW0dv7Ue6/u"""
    """fpHIeVK/0T7MTMgGGYpdjLpQe8iFQe2p+S222v+BarTUpo8WqU5Arlz2woa9b5S19SK8/wK3PNIliiW6"""
    """CQAAAABJRU5ErkJggg=="""
)
