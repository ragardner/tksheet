    ...
    return DotDict(
        {
            **theme_light_blue,
            ...
            "sort_cells_x_image": tk.PhotoImage(data=ICON_RIGHT),
            "sort_row_image": tk.PhotoImage(data=ICON_RIGHT),
            "sort_column_image": tk.PhotoImage(data=ICON_DOWN),
            "sort_rows_image": tk.PhotoImage(data=ICON_DOWN),
            "sort_columns_image": tk.PhotoImage(data=ICON_RIGHT),
            # compounds
            ...
            "sort_cells_x_reverse_image": tk.PhotoImage(data=ICON_LEFT),
            "sort_row_reverse_image": tk.PhotoImage(data=ICON_LEFT),
            "sort_column_reverse_image": tk.PhotoImage(data=ICON_UP),
            "sort_rows_reverse_image": tk.PhotoImage(data=ICON_UP),
            "sort_columns_reverse_image": tk.PhotoImage(data=ICON_LEFT),
            # reverse compounds
