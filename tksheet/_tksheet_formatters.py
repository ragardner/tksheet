...
def to_str(v: Any, **_) -> str:
    return f"{v}"


def float_to_str(v: Union[int, float], **kwargs) -> str:
...
def percentage_to_str(v: Union[int, float], **kwargs) -> str:
...
def int_formatter(
    ...
    **kwargs,
    ...
    return formatter(datatypes=datatypes, format_function=format_function, to_str_function=to_str_function, **kwargs)
...
def data_to_str(value="", datatypes=int, nullable=True, invalid_value="NaN", to_str_function=None, **kwargs) -> str:
